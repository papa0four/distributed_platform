...
//  */
// static struct sockaddr_in setup_scheduler (struct sockaddr_in scheduler)
// {
...
//     scheduler = setup_scheduler(scheduler);
...
//     bytes_recv = recv(client_conn, &p_packet_hdr->version, sizeof(uint32_t), 0);
//     if (-1 == bytes_recv)
//     {
//         perror("version recv");
//         CLEAN(p_packet_hdr);
//         return NULL;
//     }
//     p_packet_hdr->version = ntohl(p_packet_hdr->version);

//     bytes_recv = recv(client_conn, &p_packet_hdr->operation, sizeof(uint32_t), 0);
//     if (-1 == bytes_recv)
//     {
...
//     p_packet_hdr->operation = ntohl(p_packet_hdr->operation);
